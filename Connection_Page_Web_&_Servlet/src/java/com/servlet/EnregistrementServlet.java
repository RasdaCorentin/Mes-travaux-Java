...
public class EnregistrementServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EnregistrementServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // processRequest(request, response);
        ...
        String pays = request.getParameter("pays");
         ...
         //response.getWriter().write("Vous avez " + age + "ans.");
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("bienvenue.jsp");
